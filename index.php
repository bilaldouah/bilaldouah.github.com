...
<div class="nav-bar-pc">
    <nav class="navbar" id="navbar" >
        ...
        <ul>
            ...
            <li><a  onclick="hideMenu()" href="#Über mich">Über mich</a> </li>
...
<div class="fixed-top">
  ...
  <nav class="navbar navbar-dark bg-dark ">
    ...
    <section class="article" id="Über mich">

        <h2 class="headings"><img src="Image/icons8-person-64 (1).png" width="40px" /> ÜBER MICH</h2>
        <div class="articlebody">
            ...
            <div class="resume">
                ...
                <p> Mein Name ist Bilal Douah, ich bin 23 Jahre alt, stamme aus Marokko. Ich habe im Juni 2016 mein
                    Abitur in der Wissenschaft von Bio- und Geologie abgeschlossen, Da Englisch der Schlüssel zum IT
                    Bereich ist,
                    habe ich Englisch an der Fakultät studiert, um meine Sprachkenntnisse zu verbessern.
                </p>
                <p style=" padding-top: 30px;">
                    Ein Jahr später habe ich im Fachinstitut für angewandte Technologie mein Studium angefangen und im
                    Juni 2019 erlangte ich mein Diplom als Spezialisierter Techniker im Fachbereich: Techniken der
                    IT-Netzwerke. Schon als Schüler,
                    ...
                    rahmenbedingungen für Auszubildender an,
...
<div class="article" id="Schulbildung" >
        ...
        <div class="schulbildung">
            ...
            <div class="box">
                ...
                <p><strong>Wo:</strong> Fachinstitut für Angewandte Technologie Lazaret <br><br>
            ...
            <div class="box">
                ...
                <p><strong>Wo: </strong>Fakultät für leteratur Mohamed 1 <br>
                    <br>
        ...
        <div class="marged-content" >
            <div class="card" >
              ...
              <div class="card-body">
                <div class="text-box">
                    <h3> Praktikum in der Universitätsklinikum Mohammed VI, Oujda </h3>
   ...
   <a style="color:white">+212695963381</a>
    ...
    <div class="con-img ">
      ...
      <div class="sm-icon-holder ">
        ...
        <a>  +212695963381   </a>
        <p>Wenn Sie mich telefonisch erreichen möchten, <br>können Sie mich unter der folgenden Nummer anrufen +212695963381</p>
      </div>
      ...
      <div class="sm-icon-holder">
        ...
        <p>Sie können mich auch auf Linkedin finden. Drücken Sie auf mein Linkedin, um mehr über mich zu sehen</p>
      </div>
      <div class="sm-icon-holder">  
        <div class="sm-icon"><i class=" fa fa-google "  ></i></div>
        <a  href="https://mail.google.com/mail/u/2/#inbox" >douah.bilaal@gmail.com</a>
        <p>Sie können mir eine E-Mail senden, wann immer Sie möchten. Ich freue mich sehr, von Ihnen zu hören</p>
      </div>
    </div>
      </div>
